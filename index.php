...
<body>
    ...
    <footer>
        ...
        <?php 
            $htmlurl = 'http://validator.w3.org/check?uri=https://clerickbarrionweb250.000webhostapp.com'.$_SERVER['REQUEST_URI'];
            $cssurl = 'http://jigsaw.w3.org/css-validator/validator?uri=https://clerickbarrionweb250.000webhostapp.com'.$_SERVER['REQUEST_URI'];
            echo "
